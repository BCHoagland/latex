...
\begin{note}[]
	The proofs of \Cref{bellmanoperator} and \Cref{bellmanoptimalityoperator} show that in the finite MDP setting, the Bellman equation \& Bellman optimality equation for value functions have unique solutions.
\end{note}
...
\warn{Write actual proposition about all 4 bellman operators being contraction maps}
...
\begin{proof}
	...
	To show (2), a computation similar to \Cref{bellmanoperator} shows that the Bellman optimality operator
	\[
