...
\]
Note that we can express $x_3$ in terms of $x_1$ and $x_2$. Doing so, all relations simplify to the same one, giving
\[
...
\[
\ang{a,b \;|\; aba=bab}.
\] This isn't a particularly substantive change, just a cosmetic one. Alternatively, if we let $a = x_1x_2x_1$ and $b=x_2x_1$, then $a^2 = (x_1x_2x_1)(x_1x_2x_1) = (x_2x_1x_2)(x_1x_2x_1) = b^{3}$. Thus an equivalent presentation of the knot group is
\[
\ang{a,b \;|\; a^{2}=b^{3}}.
