...
We can consider what happens in the limit for certain rules. If $F_{i}(\beta)\to 0$ for both $i$, then by the proof of \Cref{2c-limits}, $\beta\to 0$ as well. Then a simple computation yields
\[
	\var_{i}(s) = \delta^{-2}
